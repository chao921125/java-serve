...
CREATE TABLE `sys_department` (
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '1' COMMENT '状态（1正常 0停用 9删除）',
...
CREATE TABLE `sys_menu` (
  ...
  `is_hideSubMenu` char(1) DEFAULT NULL COMMENT '是否隐藏子路由（0否 1是）',
