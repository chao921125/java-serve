...
public class SysRoleMenuServiceImpl extends ServiceImpl<SysRoleMenuMapper, SysRoleMenu> implements SysRoleMenuService {
	 ...
	 */
	@Override
	public List<SysRoleMenu> selectAllSysRoleMenu() {
		return sysRoleMenuMapper.selectAllSysRoleMenu();
	}
	 ...
	 */
	@Override
	public SysRoleMenu selectSysRoleMenuById(@Param("id") Long id) {
	 ...
	 */
	@Override
	public List<SysRoleMenu> selectSysRoleMenuByCondition(SysRoleMenu sysRoleMenu) {
		return sysRoleMenuMapper.selectSysRoleMenuByCondition(sysRoleMenu);
	}
	 ...
	 */
	@Override
	public Integer deleteSysRoleMenuById(@Param("id") Long id) {
	 ...
	 */
	@Override
	public Integer updateSysRoleMenuById(SysRoleMenu sysRoleMenu) {
		return sysRoleMenuMapper.updateSysRoleMenuById(sysRoleMenu);
	}
