...
import com.cc.server.vo.auth.LoginResponseVO;
...
public class SysAuthController {
	...
	@PostMapping("/login")
	public ApiResponse<LoginResponseVO> login(@RequestBody SysUserVO loginVO) {
		// 1. 参数验证
		...
		LoginResponseVO resp = new LoginResponseVO(token, user);
